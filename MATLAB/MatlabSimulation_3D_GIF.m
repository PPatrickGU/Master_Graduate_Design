...
pic_num = 1; % In order to create the gif
...
%     axis equal;
    ...
    % In order to create the gif
    F=getframe(gcf);
    I=frame2im(F);     
    [I,map]=rgb2ind(I,256);
     if pic_num == 1
         imwrite(I,map,'Simulation_3D.gif','gif','Loopcount',inf,'DelayTime',0.5);
     else
         imwrite(I,map,'Simulation_3D.gif','gif','WriteMode','append','DelayTime',0.5);
     end
